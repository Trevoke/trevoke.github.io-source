...
#+KEYWORDS:    development, engineering, psychology, test suite, tdd, stress
#+TAGS:        stress, development, tdd, psychology, testing
#+LANGUAGE:    en
#+OPTIONS:     H:3 num:nil toc:nil \n:nil ::t |:t ^:nil -:nil f:t *:t <:t
#+DESCRIPTION: A rapid test suite means your developers can play with the codebase. This is a good thing.
